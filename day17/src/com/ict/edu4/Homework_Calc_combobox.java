...
public class Homework_Calc_combobox extends JFrame{
	public Homework_Calc_combobox() {
		super("계산기");
		...
		String[] combo = {"선택하세요", "+", "-", "*", "/"};
		JComboBox<String> jc = new JComboBox<>(combo);

		// JRadioButton은 ButtonGroup 만들어서 넣자
		ButtonGroup bg = new ButtonGroup();
	
		
		np.add(new JLabel("수1 : ")); // 위에주석처리한 것과 동일한 방법임
		np.add(jtf1);
