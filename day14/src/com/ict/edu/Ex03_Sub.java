...
// 상속관계 : 자식클래스가 부모클래스의 멤버필드와 멤버메소드를 
...
public class Ex03_Sub extends Ex03_Super{
	...
	public void play() {
		...
		// System.out.prinln(super.dog);
		
		// static인 경우
		System.out.println(computer);
		System.out.println(this.computer);
		System.out.println(Ex03_Sub.computer); // static은 클래스.이름 으로 하는것이 좋음

		System.out.println(playStation);
		System.out.println(this.playStation);
		System.out.println(super.playStation);
		System.out.println(Ex03_Super.playStation); // 되도록 클래스.이름으로 쓸것
	}
}
