...
public class Ex04_Random {
	public static void main(String[] args) {
		...
		// 1) random()
		System.out.println("Math.random() : " + Math.random()); // 0.0 ~ 1.0미만 (=double이랑 똑같음)
		
		// 특정범위 지정
		System.out.println("Math.random(0~4) : " + (int)(Math.random() * 5));
		
		// 올림, 버림, 반올림
		System.out.println("올림 : " + Math.ceil(3.45)); // 예상결과 : 4
		System.out.println("올림 : " + Math.ceil(3.55)); // 예상결과 : 4
		
		System.out.println("반올림 : " + Math.round(3.45)); // 예상결과 : 3
		System.out.println("반올림 : " + Math.round(3.55)); // 예상결과 : 4
		
		System.out.println("버림 : " + Math.floor(3.45)); // 예상결과 : 3.0
		System.out.println("버림 : " + Math.floor(3.55)); // 예상결과 : 3.0
	}
}
