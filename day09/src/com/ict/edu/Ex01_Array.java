...
public class Ex01_Array {
	...
	public static void main(String[] args) {
		...
		// 		반드시 같은 자료형 이어야 한다. (단, 프로모션, 디모션은 가능)
		...
		// 3. 데이터 저장 : 이름[index = 방번호 = 위치 = 0부터 시작]
		//				같은 자료형 이어야만 저장 가능(프로모션, 디모션 가능)
		su[0] = 100;
		su[1] = 'a'; // 프로모션 (int가 더 크니까 char 가능)
		su[2] = (int) 2.4; // 디모션 => 형변환 하면 가능 대신 소수점은 날아감
		su[3] = 124;
		// su[4] = 14; // 실행 오류 (배열크기보다 크면 실행오류, 대신 배열 위치에 값 안넣는거는 오류 아님)
		su[0] = 12; // 현재 데이터를 삭제하고 12가 저장됨. (= 변수와 같음)
		...
		// 				그러나 특정 몇개나 특정 하나를 별도로 출력하거나 가공할수 없다 (단점)
		//				인덱스값을 이용할 수 없다.
